  ...
  const personagensTotal = await Promise.all([
    ...
    prisma.personagem.create({
      data: {
        ...
        sagas:
          "Saga dos Androides, Saga de Cell, Saga majin Boo, Saga Batalha dos Deuses, Saga Universo 6 vs Universo 7, Saga do Torneio do Poder",
        biografia:
  ...
  const personagens = await prisma.collection.create([
    {
      data: {
        name: "Andróide 19",
        imageUrl:
          "https://static.wikia.nocookie.net/dragonball/images/0/0d/Android19FBNV.png/revision/latest?cb=20140408201553&path-prefix=pt-br",
        ki: "800 mil",
        planetaId: 1,
        racaId: 1,
        tecnicasEspeciais: "Absorção de energia, energia ilimitada",
        ...
        biografia:
          "Andróide 19 é um dos antagonistas da Saga dos Andróides em Dragon Ball Z. Ele é um andróide criado pelo Dr. Gero com o objetivo de eliminar Goku. Andróide 19 é conhecido por sua força imensa e habilidades de combate avançadas.",
      },
      data: {
      ...
      data: {
        ...
        transformacoes: "Não",
        sagas:
          "Saga Batalha dos Deuses, Saga Universo 6 vs Universo 7, Saga do Torneio do Poder, Saga Super Hero",
        biografia:
      ...
      data: {
        ...
        transformacoes: "Não",
        sagas:
          "Saga Sayajins, Saga Freeza, Saga de Cell, Saga Majin Boo, Dragon Ball Super",
        biografia:
